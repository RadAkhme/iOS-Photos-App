...
extension CompositionalModel {
    ...
    [CompositionalModel(image: UIImage(named: "photo8") ?? UIImage(), mainTitle: "Недавние", photoCount: 15),
     ...
     CompositionalModel(image: UIImage(named: "photo9") ?? UIImage(), mainTitle: "Недавние", photoCount: 7),
     CompositionalModel(image: UIImage(named: "photo1") ?? UIImage(), mainTitle: "Недавние", photoCount: 7),
     CompositionalModel(image: UIImage(named: "photo2") ?? UIImage(), mainTitle: "Недавние", photoCount: 7),
     CompositionalModel(image: UIImage(named: "photo3") ?? UIImage(), mainTitle: "Недавние", photoCount: 23),
     CompositionalModel(image: UIImage(named: "photo4") ?? UIImage(), mainTitle: "Недавние", photoCount: 3)],
